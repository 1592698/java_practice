...
class OutClass_02 {
	 ...
	 * 내부 클래스가 외부 클래스의 생성과 무관하게 사용 할 수 있어야 하고,
	 * 정적 변수도 사용할 수 있어야 할 때 사용.
	...
	static class InStaticClass{ //static 내부 클래스
		...
		void inTest() { //정적 클래스의 일반메서드
			//num += 10; //외부 클래스의 인스턴스 변수는 사용 할 수 없음
			//외부 클래스 객체를 생성하지 않고 바로 정적 내부 클래스의 객체 생성할 수 있어서
			//외부 클래스의 인스턴스 변수 사용을 막음
