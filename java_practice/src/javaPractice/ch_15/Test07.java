 ...
 * 
 * 예제에서 사용하는 Constructor, Method, Filed 등의 클래스는
 * java.lang.reflect 패키지에 정의 되어 있음.
 * Class 클래스와 java.lang.reflect 패키지의 클래스를 사용하면 리플렉션 프로그램이 가능.
 * */
public class Test07 {
...
//		Class strClass = Class.forName("javaPractice.ch_15_.Test07");
