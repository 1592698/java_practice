...
public class MyShop implements IShop {
	...
	String title;
	@Override
	public void setTitle(String title) { //쇼핑몰제목(이름) 설정
		this.title =title;
	}
	/*
...
//		users[1]=user;
		...
		System.out.print("결제 수단을 선택해 주세요. CASH(0), CARD(1)");
	...
	public void genProduct() {
		CellPhone cellPhone = new CellPhone("갤럭시 노트5",1000000, "SKT", "samsung","a123");
		products[0] = cellPhone;
		cellPhone = new CellPhone("애플 아이폰7", 9800000, "KT","apple","b333");
		products[1] = cellPhone;
		SmartTv smartTv = new SmartTv("삼성 3D Smart TV", 5000000, "4K",100, "c555");
		products[2] = smartTv;
